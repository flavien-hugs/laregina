    ...
    operations = [
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('civility', models.CharField(choices=[('M.', 'Monsieur'), ('Mme', 'Madame'), ('Mlle', 'Mademoiselle')], default='Mr', max_length=4, verbose_name='civilité')),
                ...
                ('phone_number', phonenumber_field.modelfields.PhoneNumberField(help_text='+225xxxxxxxx', max_length=128, region=None, verbose_name='numéro de téléphone')),
                ('whatsapp_number', phonenumber_field.modelfields.PhoneNumberField(blank=True, help_text='+225xxxxxxxx', max_length=128, region=None, verbose_name='numéro de téléphone WhatsApp')),
