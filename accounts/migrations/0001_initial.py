    ...
    operations = [
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('civility', models.CharField(choices=[('M.', 'Monsieur'), ('Mme', 'Madame'), ('Mlle', 'Mademoiselle')], default='M.', max_length=4, verbose_name='civilité')),
                ('store_id', models.CharField(blank=True, max_length=10, null=True, unique=True, verbose_name='ID STORE')),
                ...
                ('store', models.CharField(blank=True, max_length=80, null=True, verbose_name='boutique')),
