...
def promotion_create_view(
    request, template="dashboard/seller/includes/_partials_promotion_form.html"
):
...
class PromotionListView(SellerRequiredMixin, mixins.PromotionMixin, generic.ListView):
...
def promotion_update_view(
    request, slug, template="dashboard/seller/includes/_partials_promotion_form.html"
):
...
class PromotionDeleteView(SellerRequiredMixin, SuccessMessageMixin, generic.DeleteView):
    model = models.Promotion
...
class PromotionDetailView(
    mixins.PromotionMixin, generic.DetailView, generic.list.MultipleObjectMixin
):
    paginate_by = 25
    slug_field = "slug"
    model = models.Promotion
