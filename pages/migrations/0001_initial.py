    ...
    operations = [
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('name', models.CharField(blank=True, choices=[('Destockage', 'Destockage'), ('Vente Flash', 'Vente Flash'), ('Nouvel Arrivage', 'Nouvel Arrivage')], default='Vente Flash', max_length=120, null=True, verbose_name='campagne')),
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('created_at', models.DateTimeField(default=django.utils.timezone.now, editable=False, verbose_name='date de création')),
                ('updated_at', models.DateTimeField(auto_now=True)),
                ('page', models.PositiveIntegerField(choices=[(0, 'Page par défaut'), (1, 'Page Supermarché'), (2, 'Page Combinée')], default=0, verbose_name='Page')),
            ],
            options={
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('updated_at', models.DateTimeField(auto_now=True)),
                ('slug', models.SlugField(blank=True, help_text='Automatiquement formé à partir du nom.', max_length=225, null=True, unique=True, verbose_name='URL de la boutique')),
                ('is_active', models.BooleanField(default=False, help_text='Activé/Désactivé ?', verbose_name='Activé/Désactivé')),
            ],
            options={
        ...
        migrations.AddField(
            model_name='promotion',
            name='products',
            field=models.ManyToManyField(help_text='Choisir des produits', to='catalogue.Product', verbose_name='produits'),
        ),
        migrations.AddField(
            model_name='promotion',
            name='user',
