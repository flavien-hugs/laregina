    ...
    operations = [
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('status', models.CharField(choices=[('Soumis', 'Soumis'), ('En cours de livraison', 'Commande en cours de livraison'), ('Commande reçue', 'Commande reçue'), ('Commande annulée', 'Commande annulée')], default='Soumis', max_length=26, verbose_name='status de le commande')),
