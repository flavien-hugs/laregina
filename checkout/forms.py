...
class CheckoutForm(forms.ModelForm):
    ...
    def __init__(self, *args, **kwargs):
        ...
        shipping_adress_text = (
            "Votre adresse géographique, ex. : Quartier N°/Nom de la rue, etc."
        )

        self.fields["email"].widget.attrs["placeholder"] = "Entrer votre adresse email"
        self.fields["shipping_last_name"].widget.attrs[
            "placeholder"
        ] = "Entrer votre prénom"
        self.fields["shipping_first_name"].widget.attrs[
            "placeholder"
        ] = "Entrer votre nom"
        ...
        self.fields["shipping_country"].widget.attrs[
            "placeholder"
        ] = "sélection un pays"
        self.fields["shipping_city"].widget.attrs["placeholder"] = "Ville de résidence"
        self.fields["shipping_adress"].widget.attrs[
            "placeholder"
        ] = shipping_adress_text
