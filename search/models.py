...
class SearchTerm(models.Model):
    ...
    user = models.ForeignKey(
        to="accounts.User", on_delete=models.SET_NULL, verbose_name="user", null=True
    )
    ...
    date_search_at = models.DateField(
        verbose_name="date de recherche", auto_now_add=True
    )
    time_search_at = models.TimeField(
        verbose_name="heure de la recherche", auto_now=True
    )
