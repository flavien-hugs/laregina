    ...
    operations = [
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('price', models.DecimalField(decimal_places=0, default=0, help_text='Le prix du produit', max_digits=50, verbose_name='prix')),
                ('old_price', models.DecimalField(blank=True, decimal_places=0, default=0, max_digits=50, verbose_name='ancien tarif')),
                ...
                ('external_delivery', models.DecimalField(decimal_places=0, default=0, max_digits=50, verbose_name='Prix de la livraison internationale')),
                ...
                ('user', models.ForeignKey(help_text='Le magasin en charge de la vente.', limit_choices_to={'is_seller': True, 'is_staff': True, 'is_superuser': True}, null=True, on_delete=django.db.models.deletion.SET_NULL, related_name='seller', to=settings.AUTH_USER_MODEL, verbose_name='vendeur')),
            ],
            options={
